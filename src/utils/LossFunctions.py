#This code is from: https://github.com/JunMa11/SegLoss/blob/master/losses_pytorch/dice_loss.py
""""
...
__all__ = ['GDiceLoss', 'GDiceLossV2', 'SSLoss', 'SoftDiceLoss', 'IoULoss', 'TverskyLoss',
           'FocalTversky_loss', 'AsymLoss', 'DC_and_CE_loss', 'PenaltyGDiceLoss', 'DC_and_topk_loss', 'ExpLog_loss']
