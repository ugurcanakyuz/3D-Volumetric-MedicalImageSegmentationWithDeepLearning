...
class UNet3Dv2(nn.Module):
    ...
    def __init__(self, n_classes=8):
        ...
        self.max_pool_2x2x2 = nn.MaxPool3d(kernel_size=(2, 2, 2), stride=(2, 2, 2))
        self.down_conv_input = nn.Conv3d(1, 64, kernel_size=(3, 3, 3), padding="same", padding_mode="zeros")
        self.down_conv1 = self.__double_down_conv(64, 128)
        self.down_conv2 = self.__double_down_conv(128, 256)
        self.down_conv3 = self.__double_down_conv(256, 512)
