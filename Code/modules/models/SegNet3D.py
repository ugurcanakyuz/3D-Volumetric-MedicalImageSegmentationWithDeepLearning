...
class SegNet3D(nn.Module):
    # Implemented and modified from
    # https://github.com/vinceecws/SegNet_PyTorch/blob/e72eba74b42a061f02b16b6bb748093585905273/CamVid/SegNet.py
    def __init__(self, in_chn=1, out_chn=8, BN_momentum=0.5):
        ...
        self.ConvEn51 = nn.Conv3d(512, 512, kernel_size=3, padding=1)
        ...
        self.out = nn.Conv3d(64, self.out_chn, kernel_size=3, padding=1)
